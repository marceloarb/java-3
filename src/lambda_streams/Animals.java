...
class Animals {
    ...
    public static void main(String[] args) {
        ...
        //clean up the animals array by using the capsFirst() method.
        //follow instructions in the method definition. 
    ...
    static List<String> capsFirst(List<String> animaList, boolean mutate) {
    	...
    	//out of the function.  if it is false, create a copy of the animals, perform your stream
    	//operations on the copy, and return the copy of animals out of the function,
    ...
    static List<String> flipAnimals(boolean mutate) {
    	...
    	//If the booleaen parameter is true, reverse the static animals
    	//array list by mutating the array.  if the mutate boolean is false,
    ...
    //sort the animals in alphabetical order.
    	//If the booleaen parameter is true, mutating the animals list.
