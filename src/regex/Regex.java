...
class Regex {
    public static void main(String[] args) {
        ...
        System.out.println("The following pattern ('\\d'){36} matches : Matches any number 36 times. ...");
        ...
        // 2. Create a new array of the first names of the TEKmentors.
        //Use Regex to only grab the first name of every TEKmentor.  Push the values to a new array
        String[] tekMentors;
        for (String word: TEKmentors) {
        ...
        Pattern pattern1 = Pattern.compile("book|Book|books|Books");
        ...
        String[] awake = sleepy.split("sleepy");
        ...
        String notSleepy; //no punctuation marks should be here.
        	notSleepy = not_sleepy.replaceAll("[^a-zA-Z]", " ");
